...
import { BrainCircuit, Mail, Lock, LogIn, Chrome, AlertCircle } from 'lucide-react';
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-slate-700/50 rounded-xl shadow-sm bg-slate-800/50 text-sm font-medium text-white hover:bg-slate-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-slate-600"
            >
